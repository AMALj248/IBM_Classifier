...
logi_pred1=grid_1.predict(X)
log_prob = grid_1.predict_proba(X)
...
print()
print()
print("F1 Sore of the Logistic Regression model = " ,f1_score(Y , logi_pred1 , average='weighted',labels=np.unique(logi_pred1)))
print("Log Loss Score of the Logistic Regression model =  " ,log_loss(Y , log_prob ))
print("Jacard Score of the Logistic Regression model =  " ,  jaccard_score(Y , logi_pred1   ))
print()
print()
f_lst.append(f1_score(Y , logi_pred1 , average='weighted', labels=np.unique(logi_pred1)))
l_lst.append(log_loss(Y , log_prob ))
j_lst.append(jaccard_score(Y , logi_pred1   ))
...
print("Jacard Score of the KNN Classification model =  " ,  jaccard_score(Y , knn_pred ))
print("The Best K Value Has been Found as " , grid.best_estimator_)
print()
print()
f_lst.append(f1_score(Y , knn_pred , average='weighted'  , labels=np.unique(knn_pred)))
j_lst.append(jaccard_score(Y , knn_pred   ))
l_lst.append('NA')
n_lst.append('KNN')
...
print("Jacard Score of Descion Tree model =  " ,  jaccard_score(Y , tree_pred  ))
print()
print()
f_lst.append(f1_score(Y , tree_pred , average='weighted' , labels=np.unique(tree_pred)))
j_lst.append(jaccard_score(Y , tree_pred  ))
l_lst.append('NA')
...
print("Jacard Score of the SVM model =  " ,  jaccard_score(Y , svm_pred))
print()
print()
f_lst.append(f1_score(Y , svm_pred , average='weighted' , labels=np.unique(svm_pred)))
j_lst.append(jaccard_score(Y , svm_pred ))
l_lst.append('NA')
n_lst.append('SVM')
############################################## REPORT ###############################################
